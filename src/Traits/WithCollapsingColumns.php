...
trait WithCollapsingColumns
{
    ...
    // --- merged from CollapsingColumnConfiguration (#28) ---
    ...
    {
        $this->shouldAlwaysCollapse = null;
        $this->shouldMobileCollapse = null;
        $this->shouldTabletCollapse = null;
    }

    // --- merged from CollapsingColumnHelpers (#28) ---
    ...
    // --- merged from HasCollapsingColumnsStyling (#28) ---
