...
- [Available Component Methods](available-component-methods.md) documentation for Table Wide configuration
- [Filter Pills](filter-pills.md) documentation for help with configuring the pills for a filter
