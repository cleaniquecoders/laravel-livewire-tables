...
### In-Line Component
You can create components by using the [command](../01-getting-started/commands.md) or copying from one of the [examples](../16-examples/basic-example.md).
...
Your component will extend the `Rappasoft\LaravelLivewireTables\DataTableComponent` class and at minimum implement 2 methods called [configure](configuration.md) and [columns](../03-columns/creating-columns.md).
