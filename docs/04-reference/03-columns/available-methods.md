...
To change the CSS classes or other attributes assigned to a Column, use can use [setTdAttributes](../15-datatable/styling.md), which allows customising attributes based on column type, name or value.

## Sorting

See also [component sorting configuration](../08-sorting/available-methods.md).
...
### [Multi-column sorting](../08-sorting/available-methods.md#setsinglesortingstatus)
...
### [Default column sorting](../08-sorting/available-methods.md#setdefaultsort)
...
See also [component search configuration](../07-search/available-methods.md).
...
And this method is also available for the [LinkColumn](other-column-types.md#content-link-columns)
...
See more in the [clickable rows documentation](../10-rows/clickable-rows.md).
