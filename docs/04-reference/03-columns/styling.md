...
Below is a copy of the relevant sections from [datatable styling](../15-datatable/styling.md) to ensure visibility of the options.  More are documented on the main datatable styling page.
...
### Reorder Column
Note: If you are using Reorder, then the th for Reorder can be [styled separately](../12-reordering/available-methods.md).  However this is now replaced with the following to ensure consistent behaviour.  The separate method will be supported until at least v3.6
...
### Bulk Actions Column
Note: If you are using Bulk Actions, then the th for Bulk Actions can be [styled separately](../11-bulk-actions/styling.md).  However this is now replaced with the following to ensure consistent behaviour.  The separate method will be supported until at least v3.6
...
### Reorder Column
Note: If you are using Reorder, then the td for Reorder can be [styled separately](../12-reordering/available-methods.md).  However this is now replaced with the following to ensure consistent behaviour.  The separate method will be supported until at least v3.6
...
### Bulk Actions Column
Note: If you are using Bulk Actions, then the td for Bulk Actions can be [styled separately](../11-bulk-actions/styling.md).  However this is now replaced with the following to ensure consistent behaviour.  The separate method will be supported until at least v3.6
